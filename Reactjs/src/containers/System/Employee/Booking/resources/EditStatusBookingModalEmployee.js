...
import "../scss/EditStatusBookingModalEmployee.scss";
...
class EditStatusBookingModalEmployee extends Component {
  constructor(props) {
    super(props);
    this.state = {
        isShowLoading: false,
...
export default connect(mapStateToProps, mapDispatchToProps)(EditStatusBookingModalEmployee);
