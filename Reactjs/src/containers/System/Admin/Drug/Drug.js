        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><FormattedMessage id="admin.manage-doctor.unit" /></th>
                    {/* <th scope="col"><FormattedMessage id="admin.manage-doctor.name" /></th> */}
            ...
            <tbody>
              {
                drugs.map((drug,index)=>{
                  let foundUnit = units.find(element => element.key === drug.unit);
                  return(
                    <tr>
                        <td scope="row">{index+1}</td>
                        <td>{drug.name}</td>
                        <td>{ language==="en" ? foundUnit.valueEn : foundUnit.valueVi}</td>
                        <td class="text-right">
                              <button
                                className="btn-edit"
