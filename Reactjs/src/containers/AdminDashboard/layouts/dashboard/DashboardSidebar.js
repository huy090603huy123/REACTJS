...
import sidebarConfigEmployeeVi from "./sidebarConfigEmployeeVi";
...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const renderContent = (
    ...
    >
      ...
      {/* sidebar employee */}
      {userInfoState && userInfoState.roleId === USER_ROLE.EMPLOYEE && language==="vi" &&  (
        <NavSection navConfig={sidebarConfigEmployeeVi} />
      )}
      {userInfoState && userInfoState.roleId === USER_ROLE.EMPLOYEE && language==="en" && (
        <NavSection navConfig={sidebarConfigEmployee} />
      )}
