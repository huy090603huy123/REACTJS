...
const postSendSheet = (data) => {
  return axios.post("/api/send-sheet", data);
};

const postSendInvoice = (data) => {
  return axios.post("/api/send-invoice", data);
};

const postCreateSheetMedicalExaminationResult = (data) => {
  return axios.post("/api/create-sheet-medical-examination-result", data);
};
...
const filterBookingHistory = (data) => {
  return axios.post(`/api/filter-history-bookings`,data);
};

const filterBookingsByDateTimestamp = (data) => {
  return axios.post(`/api/filter-bookings-by-date-timestamp`,data);
};
...
const postCreateInvoice = (data) => {
  return axios.post("/api/create-invoice", data);
};

const viewPdf = (name, type) => {
  window.open(`${process.env.REACT_APP_BACKEND_URL}/api/view-pdf?name=${name}&type=${type}`, '_blank').focus();
};

const downloadPdf = (name, type) => {
  window.open(`${process.env.REACT_APP_BACKEND_URL}/api/download-pdf?name=${name}&type=${type}`, '_blank').focus();
  // return axios.get(`/api/download-pdf?name=${name}&type=${type}`);
};
